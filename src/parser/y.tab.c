...
{
       0,    71,    71,    77,    84,    91,    99,   107,   114,   121,
     127,   133,   146,   160,   165,   172,   180,   188,   197,   211,
     220,   228,   237,   246,   253,   260,   268,   276,   284,   292
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SELECT", "FROM", "WHERE", "AS", "AND", "OR", "CREATE", "TABLE", "ON",
  "INSERT", "DROP", "INTO", "SET", "OUTPUT", "EXIT", "'('", "')'", "','",
  "'<'", "'>'", "'='", "$accept", "SQL", "NewAtts", "WhatIWant", "Atts",
  "Tables", "AndList", "OrList", "Condition", "BoolComp", "Literal", YY_NULLPTR
};
#endif
...
{
       5,     8,     6,    13,     9,    14,   -35,    25,   -35,    27,
      12,    30,    19,    35,     4,   -35,    36,    37,    20,    38,
     -35,    39,    40,    33,    -9,   -35,    41,   -35,     8,     8,
      42,    26,    46,    47,    28,    44,    45,   -35,     0,   -35,
      48,    31,   -35,    36,    36,   -35,   -35,   -35,   -35,    34,
      49,     2,    51,    41,    -8,    -7,    52,     0,   -35,   -35,
     -35,     0,   -35,   -35,    26,    26,    26,   -35,   -35,   -35,
     -35,   -35
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      13,     0,     0,     0,     0,     1,     0,     0,     0,     0,
       9,     0,     0,     0,     2,    15,     0,     8,     0,     0,
       0,     0,     0,     0,     0,     0,     0,    16,     0,     3,
       0,    11,     7,     0,     0,    29,    27,    28,    26,     0,
      21,     0,     0,     0,     4,     0,    19,     0,    23,    24,
      25,     0,    17,    12,     0,     0,     0,    20,    22,     5,
       6,    18
};
...
{
      31,    64,    65,    45,    46,    47,    48,    21,    35,    36,
      22,     8,     1,    54,    55,    32,    32,    32,     2,    12,
      11,     3,     4,    13,     5,    15,     6,    58,    59,    60,
      69,    70,    71,    18,    14,    16,    17,    19,    20,    23,
      25,    27,    26,    30,    33,    37,    28,    29,    38,    40,
      41,    42,    43,    44,    62,    53,    63,    56,    52,    68,
       0,    57,     0,    66,    67
};

static const yytype_int8 yycheck[] =
{
       9,     9,     9,     3,     4,     5,     6,     3,    28,    29,
       6,     3,     7,    43,    44,    24,    24,    24,    13,     6,
      14,    16,    17,    14,    19,     0,    21,    25,    26,    27,
      64,    65,    66,     3,    20,     8,    24,    18,     3,     3,
       3,     3,    22,    10,     3,     3,     7,     7,    22,     3,
       3,    23,     8,     8,     3,    24,    53,    23,    10,    61,
      -1,    12,    -1,    11,    57
};
...
{
       0,     7,    13,    16,    17,    19,    21,    29,     3,    31,
      32,    14,     6,    14,    20,     0,     8,    24,     3,    18,
       3,     3,     6,     3,    33,     3,    22,     3,     7,     7,
      10,     9,    24,     3,    30,    31,    31,     3,    22,    34,
       3,     3,    23,     8,     8,     3,     4,     5,     6,    35,
      36,    38,    10,    24,    33,    33,    23,    12,    25,    26,
      27,    37,     3,    30,     9,     9,    11,    35,    38,    34,
      34,    34
};
...
#line 108 "parser.y" /* yacc.c:1646  */
    {
	tableName = (yyvsp[-3].actualChars);
	attsToCreate = (yyvsp[-1].myAttrList);
	queryType = 2;
}
...
#line 134 "parser.y" /* yacc.c:1646  */
	...
	if (strcmp ((yyvsp[0].actualChars), "Int") == 0)
		(yyval.myAttrList)->type = 0;
	else if (strcmp ((yyvsp[0].actualChars), "Float") == 0)
...
#line 147 "parser.y" /* yacc.c:1646  */
	...
	if(strcmp((yyvsp[-2].actualChars), "Int") == 0)
		(yyval.myAttrList)->type = 0;
	else if(strcmp((yyvsp[-2].actualChars), "Float") == 0)
		(yyval.myAttrList)->type = 1;
